...
RegisterNUICallback('updateLeftWristComponent', function(data)
	...
	-- print("updateLeftWristComponent:")
	-- print("componentID DATA: " .. tostring(data.componentID))
	SetPedPropIndex(GetPlayerPed(-1), 6, data.componentID, 0, 2)
	-- print("sending number of texture vars: " .. tostring(GetNumberOfPedPropTextureVariations(GetPlayerPed(-1), 1, data.componentID)))
	-- SendNUIMessage({
	-- 	type = "updateMaxVal",
	-- 	classname = "leftwrist_texture",
	-- 	maxVal = GetNumberOfPedPropTextureVariations(GetPlayerPed(-1), 1, data.componentID)
	-- })
end)
...
RegisterNUICallback('updateLeftWristTexture', function(data)
	...
	-- print("updateLeftWristTexture:")
	-- print("componentID DATA: " .. tostring(data.componentID))
	-- print("textureID DATA: " .. tostring(data.textureID))
...
RegisterNUICallback('updateRightWristComponent', function(data)
	data.componentID = math.floor(data.componentID + 0)
	-- print("updateRightWristComponent:")
	-- print("componentID DATA: " .. tostring(data.componentID))
...
RegisterNUICallback('updateSkin', function(data)
	...
	if(v == true) then
		...
		TriggerServerEvent("CMG:saveFaceData",faceSaveData)
	end
end)
...
AddEventHandler("CMG:openBarbershop",function()
