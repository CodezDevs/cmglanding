...
cfg.locations = {
    ...
    {
        name = "Sunk Oil Platform",
        position = vector3(-2835.8364257812,-549.35308837891,0.51441901922226),
        blipId = 308,
        blipColour = 0,
        dinghySpawnPositions = {
            vector3(-3523.0600585938,1383.3875732422,0.75716692209244),
            vector3(-3548.7211914062,1352.4409179688,0.38688293099403),
            vector3(-3612.1203613281,1313.3375244141,0.59710538387299),
            vector3(-3685.4899902344,1344.6182861328,1.4617813825607),
            vector3(-3724.1213378906,1333.9554443359,0.23122492432594),
            vector3(-3636.51171875,1268.6960449219,0.69323641061783),
            vector3(-3579.1799316406,1209.2998046875,0.54816710948944)
        },
        dinghySpawnHeading = 180.0,
        rewardObjects = {
            {
                objectModel = `prop_ld_gold_chest`,
                objectPosition = vector3(-2837.933, -447.648, -35.9265),
                objectRotation = 347.99926757813,
            },
            {
                objectModel = `sarcophagus`,
                objectPosition = vector3(-2858.841, -487.4777, -65.76365),
                objectRotation = 0.0,
            },
            {
                objectModel = `crate`,
                objectPosition = vector3(-2830.546, -583.4594, -74.85197),
                objectRotation = 11.499957084656,
            },
            {
                objectModel = `cashbox`,
                objectPosition = vector3(-2784.381, -636.0491, -71.7508),
                objectRotation = 26.899801254272,
            },
            {
                objectModel = `prop_cash_crate_01`,
                objectPosition = vector3(-2841.819, -403.4224, -41.24992),
                objectRotation = 0.0,
            },
            {
                objectModel = `ba_prop_battle_crate_m_bones`,
                objectPosition = vector3(-2753.313, -513.4437, -45.18926),
                objectRotation = 354.59967041016,
            },
        }
    }
}
