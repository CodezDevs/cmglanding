...
local cfg = {
    ...
    jewelryItems = {
        {name = "Gold Ring", spawnName = "jewelry_ring", sellPrice = 3000},
        {name = "Gold Watch", spawnName = "jewelry_watch", sellPrice = 15000},
        {name = "Gold Necklace", spawnName = "jewelry_necklace", sellPrice = 30000},
        {name = "Sapphire", spawnName = "sapphire", sellPrice = 100000},
    },
