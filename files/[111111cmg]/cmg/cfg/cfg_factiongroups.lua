...
cfg.metPoliceRanks = {
    ...
    {"GC Advisor", 60000, "police.advisor.whitelisted"},
...
cfg.nhsRanks = {
    {"HEMS", 40000, "nhs.hems.whitelisted"},
    {"NHS Trainee Paramedic", 25000, "nhs.traineeparamedic.whitelisted"},
    {"NHS Paramedic", 30000, "nhs.paramedic.whitelisted"},
    {"NHS Critical Care", 35000, "nhs.criticalcare.whitelisted"},
    {"NHS Junior Doctor", 40000, "nhs.juniordoctor.whitelisted"},
    {"NHS Doctor", 45000, "nhs.doctor.whitelisted"},
    {"NHS Senior Doctor", 50000, "nhs.seniordoctor.whitelisted"},
    {"NHS Specialist", 55000, "nhs.specialist.whitelisted"},
    {"NHS Consultant", 60000, "nhs.consultant.whitelisted"},
    {"NHS Captain", 65000, "nhs.captain.whitelisted"},
    {"NHS Medical Advisor", 60000, "nhs.advisor.whitelisted"},
    {"NHS Deputy Chief", 70000, "nhs.deputychief.whitelisted"},
    {"NHS Assistant Chief", 75000, "nhs.assistantchief.whitelisted"},
    {"NHS Head Chief", 80000, "nhs.headchief.whitelisted"}
}

cfg.lfbRanks = {
    {"Provisional Firefighter", 20000},
    {"Junior Firefighter", 30000},
    {"Firefighter", 32500},
    {"Senior Firefighter", 35000},
    {"Advanced Firefighter", 37500},
    {"Specalist Firefighter", 40000},
    {"Leading Firefighter", 45000},
    {"Sector Command", 50000},
    {"Divisional Command", 55000},
    {"Chief Fire Command", 60000},
}

cfg.hmpRanks = {
    {"HMP Transport", 35000, "hmp.transport.whitelisted"},
