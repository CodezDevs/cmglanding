$(document).ready(function(){
    ...
    window.addEventListener('message', function(event){
        if(event.data.radialCrosshair == true){
            $(".radial-crosshair").addClass('fadeIn');
        }

        if(event.data.radialCrosshair == false){
                ...
                if (event.data.police == true) {
                    pedMenu = new RadialMenu({
                        ...
                        onClick     : function (item) {
                            $.post('http://cmg/radialClick', JSON.stringify({
                                itemid: item.id,
        ...
        if(event.data.closeRadialMenu == true){
            ...
            $.post('http://cmg/radialDisablenuifocus', JSON.stringify({
                nuifocus: false
            }));
