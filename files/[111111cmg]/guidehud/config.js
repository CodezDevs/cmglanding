var config = {
  'title': '',
  'welcomeMessage':'CMG British RP',
  // Add images for the loading screen background.
  images: [
    'https://cmgforums.com/images/fivem/bg1.jpg', 'https://cmgforums.com/images/fivem/bg2.jpg', 'https://cmgforums.com/images/fivem/bg3.jpg',  
  ],
  ...
  'discord': {
    'show': true,
    'discordLink': 'https://discord.gg/cmg',
  },
...
var gettingstarted = [
  'Welcome to CMG',
  'The world of CMG is pretty huge so it can be a little overwhelming at first! Here\'s a couple things you can do to get started and work you way up in the world:',
  '',
